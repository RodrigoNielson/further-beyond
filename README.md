...
- Further Dice Roller: local dice rolling, dice-button interception, predetermined 3D dice, dice sound, simple custom rolls, and Game Log output.
...
- Adds an optional Further Dice Roller that uses D&D Beyond's dice button and custom simple-roll input, animates predetermined 3D dice with dice sound, and shows the results in the Game Log.
...
This creates a versioned zip file in `dist/`, for example `dist/further-beyond-0.0.72.zip`.
...
│   ├── dice-box-assets/   # Copied DiceBox audio and texture assets
